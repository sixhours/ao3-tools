...
2. In your Chrome browser, go to Chrome -> Settings -> Extensions or simply visit `chrome://extensions/` in the URL.
3. Click the "Load unpacked" button and choose the unzipped folder you downloaded in step 1.
...
3. Whenever you want to check for changes, visit the stats page and click the button again. You'll see a notice pop up in the bottom left corner of your browser noting the fics and any changes to stats.

## Copy a fic details for spreadsheet entry

1. View a fic on AO3, like https://archiveofourown.org/works/59396569/chapters/151475593
2. Click the AO3T button in your browser toolbar.
3. You'll see a notice pop up in the bottom left corner of the browser confirming the fic's title, author, word count, tags, and other details have been copied to the clipboard.
...
1. Visit a fic on an external site (ie. wattpad, ff.net, tumblr)
